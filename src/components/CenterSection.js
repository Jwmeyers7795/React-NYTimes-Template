      ...
      <div className="c-main-articles-container">
          <div className="c-main-articles">
              <article className="c-article-1">
                  ...
                  <div className="c1-headline"><a href="#" target="_self">{this.props.info.c1headline}</a></div>
                  ...
                  <br/><hr color="#D9D6D6" size="2"/>
              </article>
              <article className="c-article-2">
                  <figure className="floated-image-2"><img src={this.props.info.c2image} class="pic-width" />
                      <figcaption className="evening-briefing-pic-citation">{this.props.info.c2imagecitation}</figcaption>
                  </figure>
                  <div className="c2-headline"><a href="#" target="_self">Your Evening Briefing</a></div>
                  <div className="author">By ANDREA KANNAPELL and</div>
                  <div className="author-and-time">
                      <div className="author">SANDRA STEVENSON</div>
                      <time className="time" datetime="2015-10-8 17:55-0500">5:55 PM ET</time>
                  </div>
